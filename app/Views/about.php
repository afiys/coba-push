        ...
        <div class="row">
            <div class="col-md-12 my-2 card">
                <div class="card-body">
                    ...
                    <p>Saya adalah Syifa Salsabil wanita kelahiran Jakarta. Kecil hingga sekarang ia tinggal di Muara, Baru, Jakarta Utara</p>
                </div>
            </div>
            <div class="col-md-12 my-2 card">
                <div class="card-body">
                    <h5 class="h5">Hobby</h5>
                    <p>Saya sangat hobby berolahraga seperti berenang, badminton. Selain itu saya juga sangat suka menggambar dan memotret.</p>
                </div>
            </div>
            <div class="col-md-12 my-2 card">
                <div class="card-body">
                    <h5 class="h5">Kepribadian</h5>
                    <p>Saya adalah pribadi yang cepat dalam beradaptasi sehingga saya dapat mudah berinteraksi dengan orang baru.</p>
                </div>
            </div>
        </div>
    </div>
