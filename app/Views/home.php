...
<body>
    ...
    <div class="p-5 mb-4 bg-light rounded-3">
        <div class="container py-5">
            <h1 class="display-5 fw-bold">Hai! Selamat Datang! >w<</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-12 my-2 card">
                <div class="card-body">
                    ...
                    <p>Belajar disini bisa jadi pro CSS dan JS lho! From zero to pro!</p>
                </div>
            </div>
            <div class="col-md-12 my-2 card">
                <div class="card-body">
                    <h5 class="h5">Codeigniter asyik juga kok</h5>
                    <p>Belajarnya seru dan mengasyikkan.</p>
                </div>
            </div>
        </div>
    </div>
